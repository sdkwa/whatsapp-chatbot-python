...
class Markup:
    ...
    @staticmethod
    def inline_keyboard(keyboard: Optional[List[List[InlineKeyboardButton]]] = None) -> InlineKeyboard:
    ...
    @staticmethod
    def keyboard(keyboard: Optional[List[List[KeyboardButton]]] = None, **kwargs) -> ReplyKeyboard:
    ...
    @staticmethod
    def keyboard_button(text: str, request_contact: bool = False, request_location: bool = False) -> KeyboardButton:
