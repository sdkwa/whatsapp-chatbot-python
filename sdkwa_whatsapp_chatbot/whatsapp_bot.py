...
class WhatsAppBot(Composer):
    ...
    async def send_photo(self, chat_id: str, photo_url: str, caption: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        """Send a photo."""
    ...
    async def send_document(self, chat_id: str, document_url: str, caption: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        """Send a document."""
        return self.api_client.send_file_by_url(
            chat_id=chat_id,
    ...
    async def send_audio(self, chat_id: str, audio_url: str, caption: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        """Send an audio file."""
        return self.api_client.send_file_by_url(
            chat_id=chat_id,
            url_file=audio_url,
    ...
    async def send_location(self, chat_id: str, latitude: float, longitude: float, name: Optional[str] = None, address: Optional[str] = None) -> Dict[str, Any]:
        """Send a location."""
    ...
    async def send_contact(self, chat_id: str, phone: str, first_name: str, last_name: Optional[str] = None, company: Optional[str] = None) -> Dict[str, Any]:
        """Send a contact."""
        contact_data = {
            "phoneContact": phone,
    ...
    def flask_webhook(self, app, path: str = "/webhook") -> None:
        ...
        try:
            ...
            raise ImportError("Flask is required for flask_webhook. Install with: pip install flask")
    ...
    def fastapi_webhook(self, app, path: str = "/webhook") -> None:
        ...
        try:
            ...
            raise ImportError("FastAPI is required for fastapi_webhook. Install with: pip install fastapi")
