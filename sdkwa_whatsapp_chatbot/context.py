...
class Context:
    ...
    def _parse_update(self) -> None:
        ...
        if 'messageData' in self.update:
            ...
            self.message = Message(
                ...
                quoted_message_id=message_data.get('quotedMessage', {}).get('idMessage'),
    ...
    async def reply_with_photo(self, photo_url: str, caption: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        """Reply with a photo."""
        if not self.chat_id:
            raise ValueError("No chat_id available for reply")
    ...
    async def reply_with_document(self, document_url: str, caption: Optional[str] = None, **kwargs) -> Dict[str, Any]:
    ...
    async def reply_with_audio(self, audio_url: str, caption: Optional[str] = None, **kwargs) -> Dict[str, Any]:
    ...
    async def reply_with_location(self, latitude: float, longitude: float, name: Optional[str] = None, address: Optional[str] = None) -> Dict[str, Any]:
    ...
    async def reply_with_contact(self, phone: str, first_name: str, last_name: Optional[str] = None, company: Optional[str] = None) -> Dict[str, Any]:
    ...
    async def answer_callback_query(self, text: Optional[str] = None, show_alert: bool = False) -> Dict[str, Any]:
    ...
    async def delete_message(self, message_id: Optional[str] = None) -> Dict[str, Any]:
        ...
        msg_id = message_id or (self.message.message_id if hasattr(self, 'message') and self.message else None)
        if not msg_id:
    ...
    async def forward_message(self, to_chat_id: str, message_id: Optional[str] = None) -> Dict[str, Any]:
        """Forward a message."""
        msg_id = message_id or (self.message.message_id if hasattr(self, 'message') and self.message else None)
        if not msg_id:
            raise ValueError("No message_id available")
    ...
    def get_command_args(self) -> List[str]:
        ...
        if (hasattr(self, 'message') and self.message and 
            self.message.text and self.message.text.startswith('/')):
